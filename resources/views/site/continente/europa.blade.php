...
@section('title', 'Continente Europa')
...
<section class="section-img-pacote">
    <div>
        <h1 class="hero-title-secndary">Europa</h1>
    </div>
    <div class="imgs-blocks">
        <div class="img-overlay-pacotes">
            <img class="img-block-1-pacotes" src="https://images.unsplash.com/photo-1603808523691-a2f471d415f0?q=80&w=1495&auto=format&fit=crop" alt="">
        </div>
        
        <div class="imgs-block-2">
            <div class="img-overlay-pacotes">
                <img class="img-block-2-pacotes" src="https://images.unsplash.com/photo-1499678329028-101435549a4e?q=80&w=2070&auto=format&fit=crop" alt="">
            </div>
            
            <div class="img-overlay-pacotes">
                <img class="img-block-2-pacotes" src="https://images.unsplash.com/photo-1468914793027-6ecfb73cb1ed?q=80&w=2070&auto=format&fit=crop" alt="">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="hero-section-pacotes">
        ...
        <section class="cards-container-pacotes">
            <div class="card-pacotes">
                ...
                <a href="{{route ('site.pacote.show', 9)}}">
                <h3>Madrid</h3>
                </a>
            ...
            <div class="card-pacotes">
                ...
                <a href="{{route('site.pacote.show',10)}}">
                <h3>Paris</h3>
                </a>
                <p>Gastronomia, parques, museus.</p>
            </div>
        </section>
